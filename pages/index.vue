  ...
  <main class="p-4 max-w-[1200px] mx-auto bg-white shadow-2xl shadow-white/30">
    <article>
      <section class="mx-auto mt-4 max-w-8xl py-8 md:flex">
        ...
        <div class="mt-4 md:m-0 md:w-[50%] px-4">
          <h2 class="bg-white text-black text-[1.4em] font-montserrat font-[600] md:flex-1">
      ...
      <section class="mx-[-16px] bg-[url('/imgs/programador.jpg')] bg-cover bg-fixed bg-center p-8 flex flex-col md:flex-row md:flex-gap-4 items-center">
        <div class="backdrop-blur-lg bg-white/20 p-8 rounded-lg shadow-lg h-full w-[80%] md:w-[50%] mr-2 mb-4 md:mb-0">
          ...
          <div id="slide" class="w-full h-full justify-center items-center overflow-hidden flex flex-col md:flex-row sm:grid grid-cols-2 gap-4 justify-items-center">
            ...
            <div class="p-4 border-2 border-white w-[90%] bg-white h-[200px] mx-2 rounded-2xl bg-[url('/imgs/ex-4.jpg')] bg-cover my-4 md:mb-0 text-white" id="pagina">
              <div id="content" class="">
                conteudo
              </div>
            </div>
        ...
        <div class="backdrop-blur-lg bg-white/20 p-8 rounded-lg shadow-lg w-[80%] h-full md:w-[50%] mr-2">
          <h2 id="texto-conteiner" class="text-white text-[1.4em] font-montserrat font-[700] text-center mb-4">
          ...
          <div id="slide" class="w-full h-full justify-center items-center overflow-hidden flex flex-col md:flex-row sm:grid sm:grid-cols-2 gap-4 justify-items-center">
            ...
            <div class="p-4 border-2 border-white w-[90%] bg-white h-[200px] mx-2 rounded-2xl bg-[url('/imgs/ex-4.jpg')] bg-cover md:mb-0 text-white my-4" id="pagina ">
              <div id="content" class="">
                conteudo
              </div>
            </div>
